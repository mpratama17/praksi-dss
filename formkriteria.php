  ...
  <div class="container card shadow p-5 mt-5">
   <form action ="insertkriteria.php" method="POST">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="idkriteria" name="idkriteria">
        </div>
        <div class="mb-3">
            <label for="nmkriteria" class="form-label">Nama Kriteria</label>
            <input type="text" class="form-control" id="nmkriteria" name="nmkriteria">
        </div>
