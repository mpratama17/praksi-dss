...
<!-- .navbar -->
  ...
  <form action ="insertmatrix.php" method="POST">
    <div class="form-group">
        ...
        <input type="text" name="idmatrix" class="form-control" required="" placeholder="Masukkan ID Matrix" id="idmatrix">
    </div>
    <div class="form-group">
        <label for="idalternatif">ID Alternatif</label>
        <select class="form-control" name="idalternatif">
        <?php
            include "config.php";
        ...
        ?>
            <option value="<?php echo $c['idalternatif'];?>"><?php echo $c['nmalternatif'];?></option>
            <?php }
            ?>
        </select>        
    </div>
    <div class="form-group">
        ...
        <?php
            ...
            while($c=$b->fetch_array()){
        ?>
            <option value="<?php echo $c['idbobot'];?>"><?php echo $c['value'];?></option>
            <?php } ?>
        </select>        
    </div>
    <div class="form-group">
        ...
        <?php
            ...
            while($c=$b->fetch_array()){
        ?>
            <option value="<?php echo $c['idskala'];?>"><?php echo $c['keterangan'];?></option>
            <?php } ?>
        </select>        
    </div>
        <br></br>
